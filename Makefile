...
compilador: lex.yy.c compilador.tab.c compilador.o compilador.h tabSimbolos.o pilha.o
	gcc lex.yy.c compilador.tab.c compilador.o tabSimbolos.o pilha.o -o compilador -ll -ly -lc
